    ...
    return (
        <div className="w-full px-14 font-sans bg-yellow-500">
            <main className="w-full pt-36 pb-14 h-full space-y-4 font-sans">   
                ...
                <button className="px-6 py-3 rounded-full hover:bg-slate-800 cursor-pointer bg-slate-900 text-slate-100 font-medium" ><a href='#trending'>Start reading</a></button>
            </main>
        </div>
    )
}